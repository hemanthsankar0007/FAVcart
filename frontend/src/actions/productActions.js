...
export const createNewProduct = (productData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`${API_BASE_URL}/api/v1/admin/product/new`, productData);
...
export const deleteProduct = (id) => async (dispatch) => {
  try {
    ...
    await axios.delete(`${API_BASE_URL}/api/v1/admin/product/${id}`);
...
export const updateProduct = (id, productData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${API_BASE_URL}/api/v1/admin/product/${id}`, productData);
...
export const getReviews = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${API_BASE_URL}/api/v1/admin/reviews`, { params: { id } });
...
export const deleteReview = (productId, id) => async (dispatch) => {
  try {
    ...
    await axios.delete(`${API_BASE_URL}/api/v1/admin/review`, { params: { productId, id } });
